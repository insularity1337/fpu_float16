...
module add_tb ();
    ...
    initial begin
      ...
      $display("--------------------------------------------------------------------\"-normal + normal -> -subnormal\"");
      #90;
      a_type = 6'b100000;
